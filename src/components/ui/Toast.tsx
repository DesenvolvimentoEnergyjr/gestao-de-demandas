...
>(({ toast, onClose }, ref) => {
  ...
  const borders = {
    success:
      "border-secondary/40 shadow-[0_10px_40px_-10px_rgba(11,175,77,0.4)]",
    ...
    warning:
      "border-amber-500/40 shadow-[0_10px_40px_-10px_rgba(245,158,11,0.4)]",
  };
