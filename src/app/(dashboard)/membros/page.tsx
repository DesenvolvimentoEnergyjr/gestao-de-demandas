...
const MemberCardSkeleton = () => (
  <Card className="p-6 md:p-8 rounded-[32px] bg-white/[0.02] border border-white/5 h-full animate-pulse">
    <div className="flex flex-col items-center">
      <Skeleton className="h-20 w-20 md:h-24 md:w-24 rounded-full mb-6" />
